...
static const char *upvol[]      = { "/usr/bin/wpctl",   "set-volume", "52",      "5%+",      NULL };
static const char *downvol[]    = { "/usr/bin/wpctl",   "set-volume", "52",      "5%-",      NULL };
static const char *mutevol[]    = { "/usr/bin/wpctl",   "set-mute",   "52",      "toggle",   NULL };
*/
